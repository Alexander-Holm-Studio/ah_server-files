...
-- General Settings
Config.BankName = 'Danske Bank' -- Configurable bank name displayed in UI
...
Config.Interaction = {
    distance = 3.0, -- Afstand for at vise interaktionsprompt
    key = 38,       -- E-tast
    helpText = 'Tryk [E] for at få adgang til Danske Bank',
    accessText = 'Adgang til Danske Bank systemet!'
}
...
Config.DefaultLanguage = 'da' -- Default language: 'en', 'es', 'fr', 'ar', 'de', 'pt', 'da'
...
Config.Translations = {
    ['en'] = {
        ...
        ['welcome'] = 'Welcome to Danske Bank',
        ['balance'] = 'Balance',
        ['account'] = 'Account',
        ['amount'] = 'Amount',
        ['confirm'] = 'Confirm',
    ...
    ['es'] = {
        -- General
        ['bank_name'] = 'Danske Bank',
        ['welcome'] = 'Bienvenido a Danske Bank',
        ['balance'] = 'Saldo',
        ['account'] = 'Cuenta',
        ['amount'] = 'Cantidad',
        ['confirm'] = 'Confirmar',
    ...
    ['fr'] = {
        -- General
        ['bank_name'] = 'Danske Bank',
        ['welcome'] = 'Bienvenue à Danske Bank',
        ['balance'] = 'Solde',
        ['account'] = 'Compte',
        ['amount'] = 'Montant',
        ['confirm'] = 'Confirmer',
    ...
    ['ar'] = {
        -- General
        ['bank_name'] = 'دانسكي بنك',
        ['welcome'] = 'مرحباً بك في دانسكي بنك',
        ['balance'] = 'الرصيد',
        ['account'] = 'الحساب',
        ['amount'] = 'المبلغ',
        ['confirm'] = 'تأكيد',
    ...
    ['pt'] = {
        -- General
        ['bank_name'] = 'Danske Bank',
        ['welcome'] = 'Bem-vindo ao Danske Bank',
        ['balance'] = 'Saldo',
        ['account'] = 'Conta',
        ['amount'] = 'Quantia',
        ['confirm'] = 'Confirmar',
    ...
    ['da'] = {
        -- General
        ['bank_name'] = 'Danske Bank',
        ['welcome'] = 'Velkommen til Danske Bank',
        ['balance'] = 'Saldo',
        ['account'] = 'Konto',
        ['amount'] = 'Beløb',
        ['confirm'] = 'Bekræft',
        ...
        ['savings_account'] = 'Opsparingskonto',
        ...
        ['transaction_failed'] = 'Transaktion mislykkedes',
        ['enter_amount'] = 'Indtast beløb',
        ['enter_target'] = 'Indtast mål spiller ID',
        ['invalid_amount'] = 'Ugyldigt beløb',
        ['invalid_target'] = 'Ugyldig modtager',
        ['minimum_amount'] = 'Minimumsbeløb er %s$',
        ['maximum_amount'] = 'Maksimumsbeløb er %s$',
        ['transfer_fee'] = 'Overførselsgebyr: %s$',
        ['self_transfer'] = 'Kan ikke overføre til dig selv',
        ['player_not_found'] = 'Spiller ikke fundet',

        -- ATM
        ['atm_access'] = 'Adgang til hæveautomat',
        ['atm_card_required'] = 'Hævekort påkrævet',
        ['atm_out_of_service'] = 'Hæveautomat ude af drift',

        -- PIN
        ['enter_pin'] = 'Indtast PIN',
        ['pin_required'] = 'PIN påkrævet',
        ['pin_incorrect'] = 'Forkert PIN',
        ['pin_changed'] = 'PIN ændret',
        ['change_pin'] = 'Skift PIN',

        -- Interactions
        ['press_to_access'] = 'Tryk [E] for at åbne Danske Bank',
        ['banking_accessed'] = 'Danske Bank er åbnet',
        ['too_far'] = 'Du er for langt væk fra hæveautomaten/Danske Bank',

        -- Savings
        ['create_savings'] = 'Opret opsparingskonto',
        ['deposit_savings'] = 'Indsæt på opsparing',
        ['withdraw_savings'] = 'Hæv fra opsparing',
        ['savings_interest'] = 'Rente: %s%%',
        ['savings_created'] = 'Opsparingskonto oprettet',
        ['savings_deposit'] = 'Indsat %s$ på opsparing',
        ['savings_withdraw'] = 'Hævet %s$ fra opsparing',
        ['transfer_to'] = 'Overfør til',
        ['transfer_from'] = 'Overfør fra',
        ['account_closure'] = 'Konto lukket',

        -- Admin
        ['admin_panel'] = 'Adminpanel',
        ['manage_accounts'] = 'Administrer konti',
        ['view_logs'] = 'Se logfiler',
        ['insufficient_permission'] = 'Utilstrækkelig tilladelse',

        -- Errors
        ['database_error'] = 'Databasefejl opstod',
        ['connection_error'] = 'Forbindelsesfejl',
        ['timeout_error'] = 'Forespørgslen udløb',
