        ...
        if state then
            if currentSpeed >= 120 then
                lib.notify({
                    ...
                    description = 'Maximum speed reached (120 MPH)',
                    type = 'error',
                    icon = 'gauge-high',
                    duration = 2000
                })
            ...
            lib.notify({
                title = 'Cruise Control',
                description = 'Speed increased to ' .. self.currentCCSpeed .. ' MPH',
                type = 'info',
                icon = 'arrow-up',
                duration = 2000
            })
            ...
            lib.notify({
                title = 'Cruise Control',
                description = 'Speed decreased to ' .. self.currentCCSpeed .. ' MPH',
                type = 'info',
                icon = 'arrow-down',
                duration = 2000
            })
...
AddEventHandler('esx:enteredVehicle', function(vehicle, plate, seat, displayName, netId)
    ...
    -- Show seatbelt reminder notification
    lib.notify({
        title = 'Sikkerhedssele',
        description = Translate('seatbeltReminder'),
        type = 'warning',
