-- Drop all tables starting with 'phone_', 'user_phones', or 'zp_'
SET FOREIGN_KEY_CHECKS = 0;

DELIMITER //
CREATE PROCEDURE drop_custom_tables()
BEGIN
    ...
    DECLARE cur CURSOR FOR
        ...
        WHERE table_schema = DATABASE()
            AND (
                table_name LIKE 'phone\_%'
                OR table_name = 'user_phones'
                OR table_name LIKE 'zp\_%'
            );
...
CALL drop_custom_tables();
DROP PROCEDURE drop_custom_tables;
