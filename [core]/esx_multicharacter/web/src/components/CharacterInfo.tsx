...
const CharacterInfo: React.FC<CharacterInfoProps> = ({ character, onClose, isAllowedtoDelete , PlayCharacter, handleDelete, locale}) => {
  ...
  return (
    <div className='flex justify-center items-center'>
      <div className="w-[462px] bg-neutral-900 rounded-b-lg p-4 animate-slideDown border-2 border-[#fb9b0440]">
        <div className="mb-4">
          <h3 className="text-[#fb9b04] uppercase text-sm mb-3 font-semibold flex items-center">
