...
local txAdminLocale = GetConvar("txAdmin-locale", "da")
local esxLocale = GetConvar("esx:locale", "invalid")
Config.Locale = (esxLocale ~= "invalid") and esxLocale or (txAdminLocale ~= "custom" and txAdminLocale) or "da"
...
Config.EnableDefaultInventory = Config.CustomInventory == true -- Display the default Inventory ( F2 )
