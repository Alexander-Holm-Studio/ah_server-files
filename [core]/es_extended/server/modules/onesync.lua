    ...
    CreateThread(function()
        if not vehicleType then
            ...
            if xPlayer then
                ...
                -- Default to 'automobile' if no players are available to check
                vehicleType = 'automobile'
                print(("[^3WARNING^7] No players found to check vehicle type for model ^5%s^7, defaulting to 'automobile'"):format(vehicleModel))
            end
        end
