...
function runCHPPattern(k, pattern, stage)
    Citizen.CreateThread(function()
        if (not IsEntityDead(k) and DoesEntityExist(k) and (chpPatternReady[k] or chpPatternReady[k] == nil)) then
            ...
            while (not done[1] or not done[2] or not done[3] or not done[4] or not done[5] or not done[6] or not done[7] or not done[8] or not done[9] or not done[10]) do
                Wait(0) end
